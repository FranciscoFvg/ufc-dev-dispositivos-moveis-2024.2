...
import com.example.zooappgamesapp.ui.components.GameListItem

@Composable
fun HomeScreen(onGameSelected: (Game) -> Unit) {
    var searchQuery by remember { mutableStateOf("") }
    var filteredGames = remember (searchQuery) {
    ...
    Column {
        ...
        LazyColumn(
            ...
            items(filteredGames) { game ->
                GameListItem(game = game, onGameSelected = onGameSelected)
            }
        }
    }
}
